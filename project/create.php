...
if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
        ...
        $image = 'default.png'; // Change this to the actual file name of the default picture
    }
...
<div class="container d-flex justify-content-center pt-5">
    <div class="col-md-5 py-3 px-5">
        <div class="img1 d-flex justify-content-center"><img src="Sauce/logo.png" style="width:60px;"></div>
